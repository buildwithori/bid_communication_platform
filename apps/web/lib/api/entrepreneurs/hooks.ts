...
export function useLazyEntrepreneursLookup(
  ...
  const result = useInfiniteQuery({
    ...
    queryFn: ({ pageParam }) => listEntrepreneursRequest({ ...filters, cursor: pageParam }),
...
export const useInviteEntrepreneurMutation = (handlers?: MutationHandlers<EntrepreneurRecord>) =>
  useEntrepreneurMutation<EntrepreneurRecord, InviteEntrepreneurPayload>(inviteEntrepreneurRequest, handlers);
export const useUpdateEntrepreneurMutation = (handlers?: MutationHandlers<EntrepreneurRecord>) =>
  useEntrepreneurMutation<EntrepreneurRecord, UpdateEntrepreneurVariables>(updateEntrepreneurRequest, handlers);
export const useUpdateEntrepreneurStatusMutation = (handlers?: MutationHandlers<EntrepreneurRecord>) =>
  useEntrepreneurMutation<EntrepreneurRecord, UpdateEntrepreneurStatusVariables>(updateEntrepreneurStatusRequest, handlers);
export const useResendEntrepreneurInvitationMutation = (handlers?: MutationHandlers<InvitationResendResult>) =>
  useEntrepreneurMutation<InvitationResendResult, string>(resendEntrepreneurInvitationRequest, handlers);
export const useGrantProgrammeAccessMutation = (handlers?: MutationHandlers<EntrepreneurRecord>) =>
  useEntrepreneurMutation<EntrepreneurRecord, ProgrammeAccessVariables>(grantProgrammeAccessRequest, handlers);
export const useRevokeProgrammeAccessMutation = (handlers?: MutationHandlers<EntrepreneurRecord>) =>
  useEntrepreneurMutation<EntrepreneurRecord, ProgrammeAccessVariables>(revokeProgrammeAccessRequest, handlers);

export function useUpdateEntrepreneurProfileMutation(handlers?: MutationHandlers<EntrepreneurRecord>) {
  const queryClient = useQueryClient();
  return useMutation<EntrepreneurRecord, Error, EntrepreneurProfilePayload>({
    ...
    onSuccess: (data) => {
      ...
      void queryClient.invalidateQueries({ queryKey: entrepreneurKeys.lists() });
      handlers?.onSuccess?.(data);
    },
    onError: handlers?.onError,
  });
...
export const useSaveProgrammeGoalMutation = (handlers?: MutationHandlers<ProgrammeGoalRecord>) =>
  useEntrepreneurMutation<ProgrammeGoalRecord, RecordMutationVariables<ProgrammeGoalPayload>>(saveProgrammeGoalRequest, handlers);
export const useSaveFundraisingRoundMutation = (handlers?: MutationHandlers<FundraisingRoundRecord>) =>
  useEntrepreneurMutation<FundraisingRoundRecord, RecordMutationVariables<FundraisingRoundPayload>>(saveFundraisingRoundRequest, handlers);
export const useSavePeriodicUpdateMutation = (handlers?: MutationHandlers<PeriodicUpdateRecord>) =>
  useEntrepreneurMutation<PeriodicUpdateRecord, RecordMutationVariables<PeriodicUpdatePayload>>(savePeriodicUpdateRequest, handlers);

export function useAcceptEntrepreneurInvitationMutation(
  handlers?: MutationHandlers<EntrepreneurRecord>,
) {
  return useMutation<EntrepreneurRecord, Error, AcceptEntrepreneurInvitationPayload>({
