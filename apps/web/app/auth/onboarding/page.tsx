...
export default function EntrepreneurOnboardingPage() {
  return <AuthShell title="Complete signup details" description="Confirm the entrepreneur account details BID needs before opening the workspace." className="max-w-[560px]" cardClassName="p-5 sm:p-7"><OnboardingForm /></AuthShell>;
}
